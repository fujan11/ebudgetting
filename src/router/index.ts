  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        name: 'data-renstra',
        path: 'data-renstra',
        component: () => import('../pages/admin/Renstra/DataRenstra.vue'),
      },
      {
        name: 'bidangrenstra',
        path: 'bidangrenstra',
        component: () => import('../pages/admin/Renstra/bidangRenstra.vue'),
      },
      {
        name: 'detailrenstra',
        path: 'detailrenstra',
        component: () => import('../pages/admin/Renstra/detailRenstra.vue'),
      },
      {
        name: 'tahunrenstra',
        path: 'tahunrenstra',
        component: () => import('../pages/admin/Renstra/TahunRenstra.vue'),
      },
      {
        name: 'dtlsbrrenstra',
        path: 'dtlsbrrenstra',
        component: () => import('../pages/admin/Renstra/detailSebaranRenstra.vue'),
      },
      {
        name: 'datarkat',
        path: 'datarkat',
        component: () => import('../pages/admin/rkat/dataRkat.vue'),
      },
      {
        name: 'sebaranrenstra',
        path: 'sebaranrenstra',
        component: () => import('../pages/admin/Renstra/SebaranRenstra.vue'),
      },
      {
        name: 'pagu',
        path: 'pagu',
        component: () => import('../pages/admin/pagu/pagu.vue'),
      },
      {
        name: 'programkerja',
        path: 'programkerja',
        component: () => import('../pages/admin/ProgramKerja/programKerja.vue'),
      },
      {
        name: 'pengajuandana',
        path: 'pengajuandana',
        component: () => import('../pages/admin/PengajuanDana/pengajuanDana.vue'),
      },
      {
        name: 'lpj',
        path: 'lpj',
        component: () => import('../pages/admin/PengajuanDana/elpeje.vue'),
      },
      {
        name: 'unit_kerja',
        path: 'unit_kerja',
        component: () => import('../pages/admin/UnitKerja/UnitKerja.vue'),
      },
      {
        name: 'statistics',
        path: 'statistics',
